...
def LoadMesh():                                             #Load Mesh and decrease number of faces
  ...
  MeshSet.load_new_mesh("%s/%s" % (args['i'], Dateiname))
...
# Begin Inputs
fusslaenge = footlength            # This is for obtaining the scaling factor
fusslaengemeshlab = footlength_ml
skalierungsfaktor = scale_factor   # For obtaining the scaling factor
lire = foot_choise                 # Input left or right
